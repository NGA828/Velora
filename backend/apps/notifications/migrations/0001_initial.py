    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('severity', models.CharField(choices=[('INFORMATION', 'Information'), ('SUCCESS', 'Success'), ('WARNING', 'Warning'), ('CRITICAL', 'Critical')], db_index=True, default='INFORMATION', max_length=16)),
                ('title', models.CharField(max_length=180)),
                ('body', models.CharField(max_length=500)),
                ('route', models.CharField(blank=True, max_length=300)),
